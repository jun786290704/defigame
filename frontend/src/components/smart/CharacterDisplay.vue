...
.character-portrait {
  width: 6.5em;
  height: 6.5em;
  background: rgba(230, 221, 221, 0.829);
  display: flex;
  justify-content: center;
  align-items: center;
  border: 4px rgba(29, 2, 126, 0.308)) inset;
...
li.character{
  background: linear-gradient(to right, rgba(255, 255, 255, 0.336) var(--staminaReady), rgba(255, 255, 255, 0.1) 0);
  padding: 7px 4px 2px;
  margin: 5px;
