  ...
  <div class="body main-font">
    <b-navbar-nav>
      <b-nav-item-dropdown right>
        ...
        <b-dropdown-item @click="onClaimTokens()"><i class="fa fa-coins mr-2"></i>Claim Dkc </b-dropdown-item>
...
export default Vue.extend({
  ...
  computed: {
    ...(mapState(['dkcRewards', 'directStakeBonusPercent']) as Accessors<StoreMappedState>),
    ...
    formattedTaxAmount(): string {
      const dkcRewards = fromWeiEther(parseFloat(String(parseFloat(this.dkcRewards)*parseFloat(String(this.rewardsClaimTaxAsFactorBN)))) + '');
      return `${toBN(dkcRewards).toFixed(4)}`;
    },
    ...
    formattedBonusLost(): string {
      const dkcLost = fromWeiEther(parseFloat(String(parseFloat(this.dkcRewards)*this.directStakeBonusPercent/100)).toString());
