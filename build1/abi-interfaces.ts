...
export interface Blacksmith {
  ...
  spendTicket(_num: string | number): Web3JsAbiCall<void>;
...
export interface CryptoBlades {
  ...
  priceOracleDkcPerUsd(): Web3JsAbiCall<string>;
  promos(): Web3JsAbiCall<string>;
  randoms(): Web3JsAbiCall<string>;
  ...
  renounceRole(role: string, account: string): Web3JsAbiCall<void>;
  revokeRole(role: string, account: string): Web3JsAbiCall<void>;
  dkcToken(): Web3JsAbiCall<string>;
  stakeFromGameImpl(): Web3JsAbiCall<string>;
  totalInGameOnlyFunds(): Web3JsAbiCall<string>;
  weapons(): Web3JsAbiCall<string>;
  initialize(_dkcToken: string, _characters: string, _weapons: string, _priceOracleDkcPerUsd: string, _randoms: string): Web3JsAbiCall<void>;
  migrateTo_ef994e2(_promos: string): Web3JsAbiCall<void>;
  ...
  recoverDkc(amount: string | number): Web3JsAbiCall<void>;
  getDkcToSubtract(_inGameOnlyFunds: string | number, _tokenRewards: string | number, _dkcNeeded: string | number): Web3JsAbiCall<[string, string, string]>;
  getDkcNeededFromUserWallet(playerAddress: string, dkcNeeded: string | number): Web3JsAbiCall<string>;
  ...
  spendTicket(num: string | number): Web3JsAbiCall<void>;
  ...
  mintWeaponN(num: string | number): Web3JsAbiCall<void>;
  ...
  setCharacterLimit(max: string | number): Web3JsAbiCall<void>;
  giveInGameOnlyFunds(to: string, dkcAmount: string | number): Web3JsAbiCall<void>;
  giveInGameOnlyFundsFromContractBalance(to: string, dkcAmount: string | number): Web3JsAbiCall<void>;
  usdToDkc(usdAmount: string | number): Web3JsAbiCall<string>;
  ...
  getTotalDkcOwnedBy(wallet: string): Web3JsAbiCall<string>;
...
export interface NFTMarket {
  ...
  initialize(_dkcToken: string, _taxRecipient: string): Web3JsAbiCall<void>;
...
export interface DkcStakingRewards {
  acceptOwnership(): Web3JsAbiCall<void>;
  balanceOf(account: string): Web3JsAbiCall<string>;
  earned(account: string): Web3JsAbiCall<string>;
  enableFailsafeMode(): Web3JsAbiCall<void>;
...
export interface DkcStakingRewardsUpgradeable {
  balanceOf(account: string): Web3JsAbiCall<string>;
  earned(account: string): Web3JsAbiCall<string>;
  enableFailsafeMode(): Web3JsAbiCall<void>;
  exit(): Web3JsAbiCall<void>;
