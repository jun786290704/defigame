  ...
  <div class="body main-font">
    <b-navbar>
      ...
      <b-nav-item
        ...
        <span class="gtag-link-others" tagname="claim_dkc">
          <strong>DKC</strong> {{ formattedDkcReward }}
...
export default Vue.extend({
  ...
  computed: {
    ...
    formattedTaxAmount(): string {
      const dkcRewards = fromWeiEther((parseFloat(this.dkcRewards)* parseFloat(String(this.rewardsClaimTaxAsFactorBN))).toString());
      return `${toBN(dkcRewards).toFixed(4)}`;
    },

    formattedBonusLost(): string {
      const dkcLost = fromWeiEther((parseFloat(this.dkcRewards)*this.directStakeBonusPercent/100).toString());
