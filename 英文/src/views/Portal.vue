<template>
  <div class="body main-font">
    <div class="blank-slate">
      ...
      <div class="blank-slate" v-if="userAccount === null && !has5DkcBalance">
        In order to use the Portal, you will need at least <b>5 DKC!</b> Please add some here:
        <a v-bind:href="`${getExchangeUrl}`" target="_blank">Swap DKC/BNB</a>
      </div>
      <div class="blank-slate" v-if="userAccount === null && has5DkcBalance">
        Connect WAX wallet
        <br />
...
export default {
  ...
  computed: {
    ...mapState(['defaultAccount', 'dkcBalance', 'inGameOnlyFunds', 'dkcRewards']),
    ...mapGetters(['getExchangeUrl', 'hasStakedBalance']),

    has5DkcBalance() {
      return toBN(fromWeiEther(this.dkcBalance)).plus(toBN(fromWeiEther(this.dkcRewards))).gte(5);
    },
  },
