    ...
    AccessControlUpgradeable
{
    ...
    // Initializer
    // ############
    function initialize(IERC20 _dkcToken, address _taxRecipient)
        public
        initializer
    {
    ...
    // State
    // ############
    IERC20 public dkcToken; //0x154A9F9cbd3449AD22FDaE23044319D6eF2a1Fab;
    address public taxRecipient; //game contract
    //IPriceOracle public priceOracleDkcPerUsd; // we may want this for dynamic pricing
    ...
    function purchaseListing(
        ...
        dkcToken.safeTransferFrom(msg.sender, taxRecipient, taxAmount);
        dkcToken.safeTransferFrom(
            msg.sender,
            listing.seller,
    ...
    function recoverDkc(uint256 amount) public restricted {
        dkcToken.safeTransfer(msg.sender, amount); // dont expect we'll hold tokens here but might as well
    }
